...
void BBDesc1(){
    ...
    std::cout<<"Manuverabilty   : ****"<<std::endl<<std::endl;
    std::cout<<"Passive Skill : Reduce enemy crit rate by 1."<<std::endl;
...
void BBDesc2(){
    ...
    std::cout<<"Survivabilty    : ******"<<std::endl;
    std::cout<<"Manuverabilty   : ****"<<std::endl<<std::endl;
    std::cout<<"Passive Skill : Reduce the next Skill CD if the skill misses."<<std::endl;
...
void BBDesc3(){
    ...
    std::cout<<"Survivabilty    : *****"<<std::endl;
    std::cout<<"Manuverabilty   : **********"<<std::endl<<std::endl;
    std::cout<<"Passive Skill : Increase enemy skill CD by 1 turn. "<<std::endl;
...
void Passive(){
    if(Player.Name == "KMS Bismarck"){
        ...
        //kosong karena passive vanguard ada pada skill nya
...
void BuffSkillDuration(){
    if(DurationPL > 0){
        if(Player.DEF <= PlayerStatAwal.DEF && Player.EvadeRate <= PlayerStatAwal.EvadeRate ){
            if(Player.Name == "KMS Bismarck"){
                Player.DEF = Player.DEF*3.2;
            }else if(Player.Name == "FN Richelieu"){
                Player.EvadeRate += 2;
            }
        ...
        if(Player.Name == "KMS Bismarck"){
            Player.DEF = PlayerStatAwal.DEF;
        }else if(Player.Name == "FN Richelieu"){
            Player.EvadeRate = PlayerStatAwal.EvadeRate;
        }
    }
}
//attack
...
void heal(){
    if(Player.Name == "KMS Bismarck"){
        Player.HP += 850 + ((rand()%35)-10);

    }else if(Player.Name == "HMS Vanguard"){
        Player.HP += 750 + ((rand()%35)-10);

    }else if(Player.Name == "FN Richelieu"){
        Player.HP += 700 + ((rand()%35)-10);

    }
    if (Player.HP >= PlayerStatAwal.HP){Player.HP = PlayerStatAwal.HP;}
